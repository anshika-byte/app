...
diabetes_model = pickle.load(open(f'{working_dir}/notebooks/diabetes.pkl','rb'))
heart_disease_model = pickle.load(open(f'{working_dir}/notebooks/heart.pkl','rb'))
kidney_disease_model = pickle.load(open(f'{working_dir}/notebooks/kindey.pkl','rb'))
